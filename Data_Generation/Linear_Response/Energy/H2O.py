...
np.save(f"/Data/H2O/Energy/{dist}_qEOM_Diag", energy_qEOM_diag)
np.save(f"/Data/H2O/Energy/{dist}_qEOM"     , energy_qEOM)
np.save(f"/Data/H2O/Energy/{dist}_fqEOM"    , energy_fqEOM)