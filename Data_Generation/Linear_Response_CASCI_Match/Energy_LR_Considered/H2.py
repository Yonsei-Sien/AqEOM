...
for ex in range(N_state - 1):
    ...
    O_dgr                           = mf_qEOM._gen_state_transfer_op(excitation_level = -(ex + 1))      
...
np.save(f"/Data/H2/Energy/{dist}_LR_qEOM"     , energy_qEOM)
np.save(f"/Data/H2/Energy/{dist}_LR_fqEOM"    , energy_fqEOM)