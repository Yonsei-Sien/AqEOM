...
np.save(f"/Data/LiH/Energy/{dist}_LR_CASCI_MATCH_qEOM_Diag", energy_qEOM_diag)
np.save(f"/Data/LiH/Energy/{dist}_LR_CASCI_MATCH_qEOM"     , energy_qEOM)
np.save(f"/Data/LiH/Energy/{dist}_LR_CASCI_MATCH_fqEOM"    , energy_fqEOM)