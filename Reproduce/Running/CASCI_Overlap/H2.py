...
# everything is correct !!! (symmetry-required degeneracies, e.g. LiH/H2O's
# Pi-symmetry pairs) -- PySCF and qEOM independently pick arbitrary bases within a
...
N_states    = 4  # H2/STO-3G full space (2 orb, 2 elec) has only 4 determinants
...
Transpiled  = PySCFTranspiler(mf_hf)  # !!! Active Space Here !!! (full molecule for H2)
...
# 4. CASCI reference (same active space as the qEOM run: full 2-orbital, 2-electron space)
mc                  = mcscf.CASCI(mf_hf, 2, 2)
