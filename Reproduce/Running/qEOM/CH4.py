...
mf              = None
if do_HF:
    x_dist      = dist / np.sqrt(3)
    mol         = gto.M(atom   = f'C 0 0 0; H {x_dist} {x_dist} {x_dist}; H {-x_dist} {-x_dist} {x_dist}; H {-x_dist} {x_dist} {-x_dist}; H {x_dist} {-x_dist} {-x_dist}', 
                        basis  = 'sto3g', 
                        charge = 0, 
                        spin   = 0)
    mf          = scf.RHF(mol)
...
Transfiled      = PySCFTranspiler(mf, 5, (1, 1)) # !!! Active Space Here !!!
print("HF Done")
