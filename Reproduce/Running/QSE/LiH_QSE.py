...
mf              = None
if do_HF:
    mol         = gto.M(atom=f'Li 0 0 0; H 0 0 {dist}', basis='sto3g', spin=0, charge=0)
    mf          = scf.RHF(mol)
...
Transfiled      = PySCFTranspiler(mf, active_space=5, active_e=(1, 1)) # !!! Active Space Here !!!
print("HF Done")
...
if do_UCC:
    ...
    mf_qc       = UCC.UCC(classic_object=Transfiled, spin_symm=True, amplitudes=ucc_amp)
    mf_qc.build()
print("UCCSD Done")
