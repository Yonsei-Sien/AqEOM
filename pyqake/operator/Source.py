...
def Pauli_Operators(N):
    #  [Input]       N : Number of qubit
    # [Output]         : List of all 4^N N-qubit Pauli strings (e.g. "II...I", "II...X", ...)
    pauli_string    = ['I', 'X', 'Y', 'Z']
    pauli_strings   = [SparsePauliOp([''.join(combo)], coeffs=[1.0]) for combo in itertools.product(pauli_string, repeat=N)]
...
########################<<< Pauli Operator Decomposer into Re (=Direct Hermitian) Op.s and Im (=Op.s w/ Im. Coef.s) Op.s based on Cartesian Decomposition
